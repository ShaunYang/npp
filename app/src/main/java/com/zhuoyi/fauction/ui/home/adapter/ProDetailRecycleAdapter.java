 ...
 */
public class ProDetailRecycleAdapter extends RecyclerView.Adapter<ProDetailRecycleAdapter.ViewHoler> {

    private LayoutInflater mInflater;

    private Context mContext;

    List<ProductDetail2.DataBean.PictureBean> picture;
    ...
    public ProDetailRecycleAdapter(Context context, List<ProductDetail2.DataBean.PictureBean> picture) {
        mContext = context;
