...
public class OrderDetailActivity extends BaseActivity {
	...
	private void orderOrderInfoPost(final String id) {
		...
		String sign = Util.createSign(OrderDetailActivity.this, timestamp, "Order", "viewOrder");
		...
		OkHttpUtils.post()
				...
				.addParams("client_id", ConfigUserManager.getUnicodeIEME(OrderDetailActivity.this))
				.addParams("user_id",ConfigUserManager.getUserId(OrderDetailActivity.this))
				.addParams("id",id+"")
				.build()
				.execute(new StringCallback() {
					...
					public void onResponse(String response) {
						...
						if (code==0) {
							...
							Picasso.with(OrderDetailActivity.this).load(orderDetail.getData().getPic()).resize(titleImg.getWidth(), titleImg.getHeight()).into(titleImg);
							...
							if(status.equals("0")){
								...
								toPay.setOnClickListener(new View.OnClickListener() {
									...
									public void onClick(View v) {
										Intent intent = new Intent(OrderDetailActivity.this, OrderSubmitActivity.class);
								...
								toPay.setOnClickListener(new View.OnClickListener() {
									@Override
									public void onClick(View v) {
										DialogUtil.showCustomerSimpleTitleDialog(OrderDetailActivity.this, true, "是否确定收货？", "确认", "取消", new CommonSimpleTitleDialog.OnSubmitClickListener() {
											@Override
											public void onSubmit(Dialog dialog) {

												String timestamp = DateUtil.getStringDate();

												String sign = Util.createSign(OrderDetailActivity.this, timestamp, "Order", "confirmReceipt");

												OkHttpUtils.post()
														.url(Constant.ORDER_CONFIRMRECEIPT)
														.addParams("sign", sign).addParams("codes", ConfigUserManager.getToken(OrderDetailActivity.this))
														.addParams("timestamp", timestamp)
														.addParams("client_id", ConfigUserManager.getUnicodeIEME(OrderDetailActivity.this))
														.addParams("user_id", ConfigUserManager.getUserId(OrderDetailActivity.this))
														.addParams("id", id)
														...
														.execute(new StringCallback() {
															...
															public void onResponse(String response) {
																...
																if (code == 0) {
																	...
																	//跳转订单详情
																	Intent intent = new Intent(OrderDetailActivity.this, OrderDetail2Activity.class);
