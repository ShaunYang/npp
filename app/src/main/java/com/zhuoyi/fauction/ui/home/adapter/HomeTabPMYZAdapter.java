...
public class HomeTabPMYZAdapter extends BaseAdapter {
    ...
    public HomeTabPMYZAdapter(Context context, List<FauctionDo> fauctionDos) {
        mContext=context;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (null == convertView)
        {
            ...
            convertView = mInflater.inflate(R.layout.home_tab_item_pmyz, null);
        ...
        viewHolder.stock_num.setText(fauctionDos.get(position).getNum()+fauctionDos.get(position).getUnit());
