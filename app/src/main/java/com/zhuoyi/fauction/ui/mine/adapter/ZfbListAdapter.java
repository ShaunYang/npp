...
public class ZfbListAdapter extends BaseAdapter {
    ...
    public ZfbListAdapter(Context context, List<MyAccount.DataBean> fauctionDos, ListView alist) {
        mContext = context;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (null == convertView) {
            ...
            convertView = mInflater.inflate(R.layout.zfbao_item, null);
                                        ...
                                        .execute(new StringCallback() {
                                            ...
                                            public void onResponse(String response) {
                                                ...
                                                if (code == 0) {
                                                    ...
                                                    // 只需要重新设置一下adapter
                                                    listview.setAdapter(ZfbListAdapter.this);
