...
public class RemindPreStartFragment extends Fragment implements XListView.IXListViewListener{
    ...
    RemindItemPreAdapter mDataAdapter;
                                 ...
                                 public void onResponse(String response) {
                                    ...
                                    // if (isFirst)
                                     ...
                                     if (code==0) {
                                         ...
                                         if (isFlash) {
                                             mDataAdapter = new RemindItemPreAdapter(getActivity(), fauctionDos);
