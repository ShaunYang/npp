...
import com.zhuoyi.fauction.ui.category.adapter.CategoryEndAdapter;
...
public class CategoryEndListFragment extends Fragment implements View.OnClickListener,XListView.IXListViewListener {

    private View viewHolder;
    private XListView xListView;

    String TAG="CategoryEndListFragment";
    CategoryEndAdapter mDataAdapter;
   ...
   // private PreviewHandler mHandler = new PreviewHandler(getActivity());
    ...
    public static CategoryEndListFragment newInstance(String param1, String param2) {
        CategoryEndListFragment fragment = new CategoryEndListFragment();
        return fragment;
    }
    ...
    private void loadDataListPost(final int pageSize,final boolean isFlash,int order){
            ...
            if(category.getId().equals("-1")){
                if(pageSize<=mPageSize){
                    ...
                    String sign= Util.createSign(getActivity(),timestamp,"Product","ended");

                    OkHttpUtils.post()
                            .url(Constant.PRODUCT_ENDED)
                                ...
                                public void onResponse(String response) {
                                    ...
                                    if (code == 0) {
                                        ...
                                        for (int i = 0; i < REQUEST_COUNT; i++) {
                                            ...
                                            fauctionDo.setDeal_h_price(temp.getString("deal_h_price"));
                                            fauctionDo.setDeal_time(temp.getString("deal_time"));
                                        ...
                                        if (isFlash) {
                                            mDataAdapter = new CategoryEndAdapter(getActivity(), fauctionDos);
