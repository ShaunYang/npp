...
public class DetailPicAdapter extends BaseAdapter {
    ...
    public DetailPicAdapter(Context context, List<ProductDetail2.DataBean.PictureBean> picture) {
        mContext=context;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(picture.get(position).getPic_name()!=null){
            Picasso.with(mContext).load(picture.get(position).getPic_name()).into(viewHolder.pic_img);
        }
