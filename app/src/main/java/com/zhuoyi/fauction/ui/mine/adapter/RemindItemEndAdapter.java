...
public class RemindItemEndAdapter extends BaseAdapter {
    ...
    public RemindItemEndAdapter(Context context, List<MyRemind> fauctionDos) {
        mContext = context;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (null == convertView) {
            ...
            convertView = mInflater.inflate(R.layout.remind_item_end, null);
        ...
        viewHolder.remindTime.setText(fauctionDos.get(position).getSurplus_time());
        //判断是否得拍
