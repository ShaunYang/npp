...
import com.zhuoyi.fauction.ui.category.fragment.CategoryPreListFragment;
...
public class CategoryPreTabActivity extends BaseActivity {
   ...
   // String[] title = { "捡漏专区", "拍卖预展", "火热进行","最新成交" };
    List<CategoryPreListFragment> categoryDoListFragments;
    ...
    protected void initComponent(Bundle bundle) {
        ...
        //
        categoryDoListFragments=new ArrayList<CategoryPreListFragment>();
        allCategory=new ArrayList<Category>();
       /* Category first=new Category();
        first.setTitle("全部");
        first.setId("-1");

        CategoryPreListFragment fcategoryDoListFragment=new CategoryPreListFragment();
        ...
        for(Category category:mCategories){
            CategoryPreListFragment categoryDoListFragment=new CategoryPreListFragment();
        ...
        for(int i=0;i<categoryDoListFragments.size();i++){
            CategoryPreListFragment categoryDoListFragment=categoryDoListFragments.get(i);
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id){
               ...
               tv.setGravity(Gravity.CENTER);   //设置居中
                if(position==0){
                    ...
                    Intent intent=new Intent(CategoryPreTabActivity.this,CategoryDoingTabActivity.class);
                    startActivity(intent);
                    finish();
                } else if(position==2){

                    Intent intent=new Intent(CategoryPreTabActivity.this,CategoryEndTabActivity.class);
                    startActivity(intent);
                    finish();
                }
            }
    ...
    public void showAllCategory(){
        ...
        menuWindow = new SelectPopWindow(CategoryPreTabActivity.this,allCategory,viewPager);
        //显示窗口
