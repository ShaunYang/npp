...
public class FauctionAllFragment extends Fragment implements XListView.IXListViewListener {
    ...
    public static FauctionAllFragment newInstance(String param1, String param2) {
        FauctionAllFragment fragment = new FauctionAllFragment();
        return fragment;
    }
    ...
    private void initComponent(){
        ...
        loadDataListPost(mPage, true, 10);
    ...
    public void onLoadMore() {
        if(mPage<=mPageSize){
            loadDataListPost(mPage,false,10);
        }else{
