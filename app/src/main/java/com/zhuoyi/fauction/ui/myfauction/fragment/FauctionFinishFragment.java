...
public class FauctionFinishFragment extends Fragment implements XListView.IXListViewListener{
    ...
    public void onLoadMore() {
        if(mPage<=mPageSize){
             loadDataListPost(mPage,false,3);
        }else{
