...
public class CategoryDoListFragment extends Fragment implements View.OnClickListener,XListView.IXListViewListener {

    private View viewHolder;
    private XListView xListView;

    String TAG="CategoryDoListFragment";
   ...
   // private PreviewHandler mHandler = new PreviewHandler(getActivity());
    ...
    public static CategoryDoListFragment newInstance(String param1, String param2) {
        CategoryDoListFragment fragment = new CategoryDoListFragment();
        return fragment;
    }
