...
public class HomeTabHRJXAdapter extends BaseAdapter {
    ...
    public HomeTabHRJXAdapter(Context context, List<FauctionDo> fauctionDos) {
        mContext=context;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (null == convertView)
        {
            ...
            convertView = mInflater.inflate(R.layout.home_tab_item_hrjx, null);
