...
public class BondFinishFragment extends Fragment implements XListView.IXListViewListener{
    ...
    public void onLoadMore() {
        Logger.i("pagesize=",mPageSize+"");
        if(mPage<=mPageSize){
             loadDataListPost(mPage,false,1);
        }else{
