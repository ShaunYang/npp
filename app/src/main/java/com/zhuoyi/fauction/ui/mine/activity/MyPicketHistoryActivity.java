...
public class MyPicketHistoryActivity extends BaseActivity implements View.OnClickListener,XListView.IXListViewListener {
    ...
    protected void initComponent(Bundle bundle) {
        ...
        setContentView(R.layout.activity_mypicket_his);
    ...
    private void loadDataListPost(final int pageSize,final boolean isFlash,int order){
            ...
            if(pageSize<=mPageSize){
                ...
                String sign= Util.createSign(MyPicketHistoryActivity.this, timestamp, "Voucher", "getVoucher");

                OkHttpUtils.post()
                        .url(Constant.VOUCHER_GETVOUCHER)
                        .addParams("sign", sign).addParams("codes", ConfigUserManager.getToken(MyPicketHistoryActivity.this))
                        .addParams("timestamp", timestamp)
                        .addParams("client_id", ConfigUserManager.getUnicodeIEME(MyPicketHistoryActivity.this))
                        .addParams("user_id",ConfigUserManager.getUserId(MyPicketHistoryActivity.this))
                            ...
                            public void onResponse(String response) {
                               ...
                               if (code == 0) {
                                   ...
                                   if (isFlash){
                                       ...
                                       mDataAdapter = new MyPicketAdapter(MyPicketHistoryActivity.this, fauctionDos);
