...
public class CategoryEndTabActivity extends BaseActivity {
   ...
   // String[] title = { "捡漏专区", "拍卖预展", "火热进行","最新成交" };
    ...
    protected void initComponent(Bundle bundle) {
        ...
        //
        categoryDoListFragments=new ArrayList<CategoryEndListFragment>();
        allCategory=new ArrayList<Category>();
        /*Category first=new Category();
        first.setTitle("全部");
        first.setId("-1");

        CategoryEndListFragment fcategoryDoListFragment=new CategoryEndListFragment();
        ...
        for(Category category:mCategories){
            CategoryEndListFragment categoryDoListFragment=new CategoryEndListFragment();
        ...
        for(int i=0;i<categoryDoListFragments.size();i++){
            CategoryEndListFragment categoryDoListFragment=categoryDoListFragments.get(i);
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id){
               ...
               tv.setGravity(Gravity.CENTER);   //设置居中
                if(position==0){
                    ...
                    Intent intent=new Intent(CategoryEndTabActivity.this,CategoryPreTabActivity.class);
                    startActivity(intent);
                    finish();

                }else if(position==1){

                    Intent intent=new Intent(CategoryEndTabActivity.this,CategoryDoingTabActivity.class);
                    startActivity(intent);
                    finish();
                } else if(position==2){
    ...
    public void showAllCategory(){
        ...
        menuWindow = new SelectPopWindow(CategoryEndTabActivity.this,allCategory,viewPager);
        //显示窗口
