...
public class HRJXFragment extends Fragment  implements View.OnClickListener,XListView.IXListViewListener{
    ...
    public static HRJXFragment newInstance(String param1, String param2) {
        HRJXFragment fragment = new HRJXFragment();
        return fragment;
    }
    ...
    private void loadDataListPost(final int pageSize,final boolean isFlash){
        ...
        if(pageSize<=mPageSize){
            ...
            String sign= Util.createSign(getActivity(),timestamp,"Main","auction");

            OkHttpUtils.post()
                    .url(Constant.MAIN_FAUCTION)
                        ...
                        public void onResponse(String response) {
                            ...
                            if(code==0){
                                ...
                                if(data!=null){
                                    ...
                                    if(isFlash){
                                        adapter=new HomeTabHRJXAdapter(getActivity(), fauctionDos);
