...
public class FauctionUnGetFragment extends Fragment implements XListView.IXListViewListener{
    ...
    public void onLoadMore() {
        if(mPage<=mPageSize){
            loadDataListPost(mPage,false,2);
        }else{
