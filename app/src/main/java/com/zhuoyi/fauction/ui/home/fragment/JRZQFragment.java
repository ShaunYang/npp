...
import com.zhuoyi.fauction.ui.home.adapter.HomeTabJRZQAdapter;
...
public class JRZQFragment extends Fragment  implements View.OnClickListener,XListView.IXListViewListener{

    private View viewHolder;
    private XListView xListView;
    HomeTabJRZQAdapter adapter;
    ...
    public static JRZQFragment newInstance(String param1, String param2) {
        JRZQFragment fragment = new JRZQFragment();
        return fragment;
    }
    ...
    private void loadDataListPost(final int pageSize,final boolean isFlash){
        ...
        if(pageSize<=mPageSize){
            ...
            String sign= Util.createSign(getActivity(),timestamp,"Main","dropCatching");

            OkHttpUtils.post()
                    .url(Constant.MAIN_DROPCATCHING)
                               ...
                               if(isFlash)
                                ...
                                if(code==0){
                                    ...
                                    if(data!=null){
                                        ...
                                        if(isFlash){
                                            adapter=new HomeTabJRZQAdapter(getActivity(), fauctionDos);
