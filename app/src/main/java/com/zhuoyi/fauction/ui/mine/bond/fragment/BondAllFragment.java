...
public class BondAllFragment extends Fragment implements XListView.IXListViewListener {
    ...
    public static BondAllFragment newInstance(String param1, String param2) {
        BondAllFragment fragment = new BondAllFragment();
        return fragment;
    }
