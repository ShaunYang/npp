 ...
 */
public class CategoryEndAdapter extends BaseAdapter {
    ...
    public CategoryEndAdapter(Context context, List<FauctionDo> fauctionDos) {
        mContext = context;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (null == convertView) {
            ...
            convertView = mInflater.inflate(R.layout.category_end_item, null);
        ...
        viewHolder.curPrice.setText("￥" + fauctionDos.get(position).getDeal_h_price() + "/"+fauctionDos.get(position).getUnit());
        viewHolder.stockNum.setText(fauctionDos.get(position).getStock() + fauctionDos.get(position).getUnit());
        viewHolder.residualTime.setText(fauctionDos.get(position).getDeal_time());
